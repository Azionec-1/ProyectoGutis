      ...
      <main className="relative z-10 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-white/20 bg-white/10 p-6 shadow-2xl backdrop-blur-md">
            <h1 className="mb-1 text-center text-2xl font-semibold text-white">Inicio de sesión</h1>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <p className="text-center text-sm text-white/80">
                El registro público queda solo para la configuración inicial del administrador.
              </p>
            </form>
          </div>
        </div>
